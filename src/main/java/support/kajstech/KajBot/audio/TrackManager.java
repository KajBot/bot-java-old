...
package support.kajstech.KajBot.audio;
...
public class TrackManager extends AudioEventAdapter {
    ...
    public void onTrackStart(AudioPlayer player, AudioTrack track) {
        ...
        if (vChan == null) { // User has left all voice channels
            ...
            info.getAuthor().getGuild().getJDA().getPresence().setGame(Game.playing(info.getTrack().getInfo().title));
        }
    }
            ...
            if (queue.isEmpty()) {
                new Timer().schedule(new TimerTask() {
                    ...
                    public void run() {
                        ...
                        g.getJDA().getPresence().setGame(Game.watching("KajsTech.support"));
                    }
                }, 500);
            } else {
